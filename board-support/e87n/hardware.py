...
class _Hardware:
    ...
    def snapshot(self):
        ...
        try:
            ...
            pass
        return {"cpu_temp_mc": max((x for x in cpu if x is not None), default=None),
                ...
                "uptime_seconds": uptime, "network": network, "storage": storage}
...
def snapshot():
    """Read a bounded, best-effort sample. Missing metrics are None, never RPM estimates."""
    return _Hardware().snapshot()
